...
class VCS(object):
    ...
    def vcs_vip(self, **kwargs):
        ...
        Examples:
            ...
            ...         dev.interface.vcs_vip(vip='fe80::cafe:beef:1000:1/64',delete=True)
            ...         dev.interface.vcs_vip(vip='10.1.1.1/24',get=True)
            ...         dev.interface.vcs_vip(vip='fe80::cafe:beef:1000:1/64',get=True)
        """
        ...
        if not get_config:
            ...
            if not delete:
                ...
                if ipaddress.version == 4:
                    config = vcs_vip(**vcs_args)
                    config.find('.//*address').set('operation',
                           'delete')
                elif ipaddress.version == 6:
                    config = vcs_vip(**vcs_args)
                    config.find('.//*ipv6address').set('operation',
                            'delete')
        elif get_config:
            vip_info = {}
